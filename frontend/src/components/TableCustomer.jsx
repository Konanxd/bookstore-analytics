...
export default function TableCustomer({ data, onEdit, onDelete }) {
  ...
  const sortedData = React.useMemo(() => {
    ...
    return [...data].sort((a, b) => {
      if (sortConfig.key === "id_pelanggan") {
      ...
      if (
        ["nama_pelanggan", "no_hp", "alamat_pelanggan"].includes(sortConfig.key)
      ) {
        return sortConfig.direction === "ascending"
...
TableCustomer.propTypes = {
  data: PropTypes.arrayOf(
    PropTypes.shape({
      id_pelanggan: PropTypes.number.isRequired,
      nama_pelanggan: PropTypes.string.isRequired,
      no_hp: PropTypes.string.isRequired,
      alamat_pelanggan: PropTypes.string.isRequired,
    })
  ).isRequired,
